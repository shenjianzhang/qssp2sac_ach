...
! of QSSP and get data from the output file of QSSP,and 
...
real munit,mtt,mpp,mrr,mtp,mpr,mrt,strike,dip,rake    ! moment tensor
...
selgra=icmp(6).eq.1
call skipline(201)
read(201,*)outfile,ioutform
if(ioutform .lt. 1 .or. ioutform .gt. 2) then
    stop ' Error in qpgetinp: bad selection of output format!'
endif
! call skipline(201)
read(201,*)twinout
